...
Z \& C mention their problems with spoken speech => non-compositionality
 After Zettlemoyer \& Collins implemented second-pass decoding which relaxed constraints on the input utterances, they achieved state-of-the-art results.
